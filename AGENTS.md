...
```powershell
python tools\run_published_protocol.py --dates YYYY-MM-DD,YYYY-MM-DD --leagues 2,3,39,281,140,135,61,48,13,11,78,71,73,130,81 --report-scope full --publish
```
...
- descubrimiento por páginas específicas de Betano cuando el protocolo sea `full`, incluyendo Champions League, Europa League, Premier League, EFL Cup/League Cup, Serie A Italia, Ligue 1, Bundesliga, LaLiga, Liga 1 Perú, Brasileirão Serie A, Liga Profesional Argentina, Copa Argentina, Copa Libertadores y Copa Sudamericana.
